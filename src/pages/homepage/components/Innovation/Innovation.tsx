            ...
            content={
              <div className={styles.paragraphs}>
                ...
                <div className={styles.text}>
                  ...
                  market trades with them at the markets specified by the lender but not to withdraw
                  them from the platform.
                </div>
                <div className={styles.text}>
                  Liquidation will be implemented as a function of time and expected balance. If the
                  lender provided 15 ETH at 20% interest rate for 30 days then the cumulative
                  balance of the borrowers positions must be 18 ETH at 30th day or 16.5 ETH at 15th
                  day. For each moment it is possible to calculate the expected balance and actual
                  balance that the borrower would have if he sold all the tokens immediately
                  accounting for liquidity. If the actual balance does not match the expected
                  balance then anyone would be allowed to execute the &quot;liquidation&quot; of the
                  borrower in exchange for a small reward specified by the lender at the time of
                  order creation. Liquidation will trigger the market sell of all the active
                  borrowers positions.
                </div>
                <div className={styles.text}>
            ...
            content={
              <div className={styles.paragraphs}>
                <div className={styles.text}>
                  ...
                  <span className="bold primary-color">
                    Auto-listing contract will allow anyone to list a token on the platform without
                    asking for anyones permission or interacting with the exchange team.
                  </span>
                </div>
                <div className={styles.text}>
                  ...
                  revenue. Listing fees will be configurable by DEX223 token holders via the voting
                  sessions.
                </div>
              </div>
            }
