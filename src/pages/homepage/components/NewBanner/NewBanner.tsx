          ...
          <div className={styles.blockWithNeonWrapper}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                ...
                and{" "}
                <TextLink
                  text="pre-sale round 2"
                  href="https://dexaran820.medium.com/dex223-pre-sale-round-2-completion-report-14f09ab079cc"
                />{" "}
                are completed.
              </p>
              <p className={styles.paragraph}>
                D223 tokens can be purchased during the ICO with ETH, USDT, USDC or DAI on Ethereum
                mainnet. You can purchase tokens with ETH (Ethereum) by simply sending it to the
                address of the smart-contract:{" "}
                <span style={{ whiteSpace: "nowrap" }}>
                  <TextLink
                    text="0x66bbb...a68879"
                    href="https://etherscan.io/address/0x66bbbc0698fd3ac3c1f8bf6e2a550d3775a68879"
                  />{" "}
              ...
              <p className={styles.paragraph}>
                You can also purchase tokens by connecting your Web3 wallet and filling out the
                purchase details in the token sale form. This method allows you to use stablecoins
                as payment.
              </p>
              ...
              <p className={styles.paragraph}>
                Read{" "}
                <TextLink
                  text="D223 Token FAQ & Wallet support (medium article)"
              ...
              <p className={styles.paragraph}>
                Have a question? Write a comment on{" "}
                <TextLink
                  text="our reddit thread"
