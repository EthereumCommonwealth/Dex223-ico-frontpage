    ...
    <div>
      ...
      <NeonBlock
        ...
        leftContent={
          <>
            <ArticleHeading
              text={
                <span>
                  Introducing our Past <br /> Achievement -{" "}
                  <a className={styles.soyLink} href="https://soy.finance" target="_blank">
                    Soy.Finance
                  </a>
                </span>
              }
            ...
            <ul className={styles.list}>
              <li className={styles.option}>
                ...
                <p className={styles.listText}>
                  Our team&apos;s credibility shines through our collaboration with{" "}
                  <a
                    target="_blank"
                    className={styles.soyLink}
                    href="https://www.callistoenterprise.com/"
                  >
                    Callisto Enterprise
                  </a>
                  , where we developed a cutting-edge exchange that met their specific needs and
                  standards.
                </p>
              </li>
              <li className={styles.option}>
                ...
                <p className={styles.listText}>
                  Trust is paramount in the crypto world, and we&apos;re proud to share that our
                  exchange has remained unhacked for three years, underlining our relentless
              ...
              <li className={styles.option}>
                ...
                <p className={styles.listText}>
                  Not only does ERC-223 offer the same reliability as ERC-20, but they also burn 40K
                  less gas, translating to cost savings and a greener footprint. Here are ERC-20
                  transactions and here are ERC-223.
                </p>
              </li>
            </ul>
          </>
        ...
        rightContent={
          <div
            ref={ref}
            className={clsx(styles.rightContent, entry?.isIntersecting && styles.animated)}
          >
