...
const slides = [
  {
    ...
    content: <div className={styles.slideParagraphs}>
      <p className={styles.primaryParagraph}>
        ...
        which resulted in a loss of $176M worth of tokens.
      </p>
      <div className={styles.calculatorLinkWrapper}>
        ...
        <div className={styles.losses}>
          ...
          <span className={styles.lossesAmount}>
            <span className={styles.showDesktop}>$176,176,311.99</span>
            <span className={styles.showTablet}>$176,17M</span>
          </span>
        </div>
      </div>
      ...
      <p className={styles.secondaryParagraph}>
        ...
        of handling user mistakes $176M worth of ERC-20 tokens were lost.
      </p>
      <p className={styles.secondaryParagraph}>
    ...
    illustration: ({ animate, key }) => <div key={key} className={styles.slide1IllustrationWrapper}>
      ...
      <div className={styles.problemCards}>
        ...
        <LostCard animate={animate} active color="#FF3333" lost={"$176M"}
