...
export default function App({ Component, pageProps }: AppProps) {
  ...
  return <>
    ...
    {isProd && typeof window != "undefined" && !(window as any).mixpanel && (
      <Script
        strategy="afterInteractive"
        id="mix"
        dangerouslySetInnerHTML={{
          __html: `
          const MIXPANEL_PROJECT_TOKEN = "c0a269d5e894cf3e611e443de7d9a9db";
          const MIXPANEL_PROXY_DOMAIN = "https://api.kos-data.com/tracking";
          ...
          mixpanel.init(MIXPANEL_PROJECT_TOKEN, {debug: false, api_host: MIXPANEL_PROXY_DOMAIN, persistence: 'localStorage'});          
