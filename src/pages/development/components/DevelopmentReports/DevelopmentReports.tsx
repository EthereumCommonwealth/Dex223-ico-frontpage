    ...
    <div>
      ...
      <NeonBlock
        ...
        leftContent={
          <>
            <div className={styles.paragraphs}>
              <p className={styles.biggerText}>Summaries will be published here monthly.</p>
            </div>
            <ul className={styles.problemsList}>
              {reports.map((report) => {
                return (
                  <li key={report.text} className={styles.problemItem}>
        ...
        rightContent={
          <div
            ref={reportsEntryRef}
            className={clsx(styles.rightContent, reportsEntry?.isIntersecting && "animated")}
          >
            <DevSourcesBlueImage />
          </div>
        }
