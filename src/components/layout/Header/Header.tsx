    ...
    <header className={styles.header}>
      <div className={clsx("container_internal", styles.headerContent, blur && styles.blur)}>
        ...
        <div className={styles.logoAndNav}>
          ...
          <nav>
            <ul className={styles.navList}>
              <li>
                <Link prefetch={false} href="/#philosophy">
                  Philosophy
                </Link>
              </li>
              <li>
                <Link prefetch={false} href="/#margin">
                  Margin trading
                </Link>
              </li>
              <li>
                <Link prefetch={false} href="/#tokenomics">
                  Tokenomics
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link prefetch={false} href="/development">
                  Development
                </Link>
              </li>
            </ul>
        ...
        <div className={styles.settings}>
          {address && (
            <button className={styles.addressButton} onClick={open}>
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
