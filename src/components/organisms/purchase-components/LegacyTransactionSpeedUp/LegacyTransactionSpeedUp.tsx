...
function useGasEstimation({ gasPrice }: { gasPrice: bigint }) {
  ...
  const estimatedGasFee = useMemo(() => {
    return (+formatEther(gasPrice * BigInt(transactionToSpeedUp?.details.gas))).toFixed(7);
...
export default function LegacyTransactionSpeedUp({ handleClose }) {
  ...
  const [customGasPrice, setCustomGasPrice] = useState(
    addBigIntPercent(BigInt(transactionToSpeedUp.details.gasPrice), 10),
  );
    ...
    <>
      ...
      {isMetamask ? (
        ...
        <div className={styles.speedUpContent}>
            ...
            <div>
              <div className={styles.labelInputWrapper}>
                ...
                <div className={styles.helperText}>
                  ...
                  {formatEther(BigInt(+transactionToSpeedUp.details.gasPrice), "gwei")} Gwei
                </div>
              </div>
            </div>
            {customGasPriceError && speedUpType === "custom" && (
          ...
          <Spacer height={20} />
          <Button
            disabled={Boolean(customGasPriceError) && speedUpType === "custom"}
