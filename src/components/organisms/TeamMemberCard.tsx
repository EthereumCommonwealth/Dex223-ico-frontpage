...
export default function TeamMemberCard({ image, position, socials, name }: Props) {
  return (
    <div
      data-reveal
      className="grid-rows-[auto_1fr] lg:grid-rows-1 surface surface-hover rounded-5 relative overflow-hidden p-2 lg:p-5 grid grid-cols-1 lg:grid-cols-[172px_1fr] gap-3 lg:gap-5"
    >
