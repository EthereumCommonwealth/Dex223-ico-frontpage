...
function FeatureBlock({heading, content, image}) {
  ...
  } style={{transform: `perspective(700px) rotateX(${rotations.x}deg) rotateY(${rotations.y}deg)`}} className={clsx(styles.featureBlock)}>
  ...
  return <>
    ...
    leftContent={
      <>
        ...
        <p className={styles.text}>DEX223 introduces a number of revolutionary concepts that no other exchange implements in the same way currently. These features will drastically improve the security, make token listings as easy and transparent as possible and allow on-platform lending of assets.</p>
        <Spacer height={40} />
      </>
    }
  />
