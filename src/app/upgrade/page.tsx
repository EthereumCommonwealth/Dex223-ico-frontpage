"use client";
import { useAccount, useBalance, useConnect, useContractWrite, useSwitchChain } from "wagmi";
...
export default function UpgradePage() {
  ...
  const { switchChain, isLoading: loadingSwitchNetwork } = useSwitchChain();



  return <div className="max-w-[600px] mx-auto h-[calc(100vh-48px)] flex items-center justify-center relative">
