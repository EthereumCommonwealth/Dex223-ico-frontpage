            ...
            <div className="flex justify-center">
              <div className="w-[470px] rounded-5 px-10 pb-10 bg-primary-bg relative">
                ...
                <div className="bg-secondary-bg rounded-3 px-5 pt-4 pb-5">
                  ...
                  <div className="border border-secondary-border rounded-2 grid grid-cols-2 -mx-10 relative animate-erc-bg">
                    <div className="rounded-2 absolute w-1/2 animate-erc before:border-transparent before:block before:rounded-2 h-full left-0 top-0  ">
                      <div className="absolute w-full h-full animate-add-outline border-transparent border-2 rounded-2 border-green" />
                      <div className="absolute px-3 bg-green-hover text-18 top-0 opacity-0 -right-3.5 rounded-3 text-secondary-bg animate-appear-safe-choice">
                        SAFE CHOICE
                      </div>
                    </div>
