  ...
  return (
    <div>
      ...
      security, reducing exposure to malicious activities and user errors alike."
              ...
              className="flex-grow bg-[url('/images/innovation_bg_1.png')] bg-bottom bg-contain bg-no-repeat"
            />
            <KeyFeatureCard
          ...
          <div className="flex flex-col gap-5">
            ...
            confidence."
              ...
              className="flex-grow bg-[url('/images/innovation_bg_2.png')] bg-bottom bg-contain bg-no-repeat"
            />
          </div>
          <div className="flex flex-col gap-5">
            <KeyFeatureCard
