...
function LostCard({ icon, name, lost, percentage, color, active = false, animate = false }) {
  return (
    <div className={clsx(styles.lostCard, active && styles.active)}>
      <div className={styles.lostCardHeader}>
        <div className={styles.lostCardName}>
          {icon} {name}
        </div>
...
const slides = [
  {
      ...
      <div className={styles.slideParagraphs}>
        ...
        <div className={styles.calculatorLinkWrapper}>
          <p>
            ...
            <TextLink text="here" href="https://dexaran.github.io/erc20-losses" />
          </p>
        ...
        <p className={styles.secondaryParagraph}>
          ...
          for error handling. As the result of impossibility of handling user mistakes{" "}
          {ERCLossesInt} worth of ERC-20 tokens were lost.
        </p>
        <p className={styles.secondaryParagraph}>
    ...
    illustration: ({ animate, key }) => (
      <div key={key} className={styles.slide1IllustrationWrapper}>
        ...
        <div className={styles.problemCards}>
          ...
          <LostCard
            ...
            name="ERC-20 transacting errors"
            percentage={47}
          />
          <LostCard
            animate={animate}
  ...
  },
  {
    ...
    content: (
      <div className={styles.slideParagraphs}>
        ...
        <p className={styles.secondaryParagraph}>
          ERC-20 tokens can&apos;t be directly deposited to smart-contracts. An approval must be
          issued first. Approval and Swap are two different transactions. In order to reduce GAS
          costs and improve user experience DEXes suggest that user issue an unlimited approval once
          and let it stay to avoid issuing it next time. By issuing an approval the user authorizes
          the contract to do anything with the funds on users behalf and if the contract gets hacked
          15 years later the user will get their tokens drained.
        </p>
    ...
    illustration: ({ animate, key }) => (
      <div key={key} className={styles.approveProblemsWrapper}>
  ...
  },
  {
    ...
    illustration: ({ animate, key }) => (
      <div key={key} className={styles.erc20Problems}>
  ...
  },
  {
    ...
    content: (
      <div className={styles.slideParagraphs}>
        ...
        <p className={styles.secondaryParagraph}>ERC-20 swap consumed 257K GAS.</p>
    ...
    illustration: ({ animate, key }) => (
      <div key={key} className={styles.secureErc20}>
        <div>
  ...
  },
  {
    ...
    illustration: ({ animate, key }) => (
      <div key={key} className={clsx(styles.lastSlide, animate && "animated")}>
  ...
  },
  {
    ...
    illustration: ({ animate, key }) => (
      <div key={key} className={clsx(styles.gasOptimisationIllustration, animate && "animated")}>
...
function EcosystemSlide({ index, activeSlide, slide }) {
  return (
    <div className={clsx(styles.slideTest, index === activeSlide && styles.active)}>
              ...
              <div className={styles.slideTextContent}>
                ...
                <div>
                  ...
                  {slides.map((slide, index) => {
                    return (
                      <div key={index} className={styles.slideTextWrapper}>
