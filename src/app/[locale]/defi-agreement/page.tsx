    ...
    <>
      <div className="py-[60px] text-primary-text max-w-[822px] mx-auto">
        <HeadingWithSubheading
          heading="DeFi Agreement"
          subheading="DEX223 DeFI Protocol Terms of Service"
        />
        <EnglishOnlyNotice />
        <DownloadScanButton
          fileName="DeFi Agreement.pdf"
          href={encodeURIComponent("/docs/DeFi Agreement.pdf")}
        />

        <div className="flex flex-col gap-6">
          <StaticNeonBlock
            title="DeFi Protocol User Agreement"
            iconName="introduction"
            text="Welcome to the DeFi Protocol User Agreement (“User Agreement”). This document forms a legally binding contract between you (“User” or “you”) and DEX223 DAO LLC (“we,” “us,” or “our”) regarding your use of the Dex233 DeFi Protocol (“Protocol”). By accessing or utilizing the Protocol, you consent to comply with the terms and conditions outlined herein."
          />
          <StaticNeonBlock
            title="1. Definitions"
            iconName="definitions"
            text="Protocol: Refers to the decentralized finance platform operated by DEX223 DAO LLC, encompassing all related smart contracts, interfaces, and services.
User: Denotes any individual or entity engaging with or utilizing the Protocol."
          />
          <StaticNeonBlock
            title="2. Protocol Usage"
            iconName="protocol-usage"
            text={
              <OrderedList
                firstIndex={2.1}
                step={0.1}
          ...
          <StaticNeonBlock
            ...
            iconName="liability-restrictions"
            text={
              <OrderedList
                firstIndex={4.1}
                step={0.1}
          ...
          />
          <StaticNeonBlock
            title="6. Legal Governance and Resolution"
            iconName="legal-governance"
            text={
              <OrderedList
                firstIndex={6.1}
                step={0.1}
