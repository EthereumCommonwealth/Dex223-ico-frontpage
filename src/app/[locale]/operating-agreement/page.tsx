...
import EnglishOnlyNotice from "@/components/static-pages-components/EnglishOnlyNotice";
    ...
    <>
      <div className="py-[60px] text-primary-text max-w-[822px] mx-auto">
        <HeadingWithSubheading
          ...
          subheading="Navigating the Decentralized Future: DEX223 DAO LLC Operating Guidelines."
        />
        <EnglishOnlyNotice />
        <DownloadScanButton
          fileName="Operating Agreement.pdf"
          href={encodeURIComponent("/docs/Operating Agreement.pdf")}
        />
        ...
        <div className="flex flex-col gap-6">
          ...
          <StaticNeonBlock
            title="Notice of Restrictions on Duties and Transfers"
...
Phone: (877) 773-0888"
              ...
              <Paragraphs
                paragraphs={[
                  <UnorderedList
                    ...
                    listItems={[
                      <span key="1">
                        <b className="text-primary-text">Founder:</b> Spearheads the development of
                        the DAO LLC protocol, ensures security, distributes treasury funds, and
                        provides monthly progress reports.
                      </span>,
                      <span key="2">
                        <b className="text-primary-text">Co-founder:</b> Initiates the DAO LLC,
                        assembles the Freedom Development Team, oversees marketing strategies, and
                        provides strategic oversight.
                      </span>,
                      <span key="3">
                        <b className="text-primary-text">Project Manager:</b> Manages project
                        development, ensuring timely progress and goal adherence.
                      </span>,
                      <span key="4">
                        <b className="text-primary-text">The Freedom Development Team:</b>{" "}
                        Independent contracted developers building and maintaining the DEX223
                        protocol.
                      </span>,
                    ]}
                  />,
          ...
          <StaticNeonBlock
            ...
            iconName="decision"
            text="Decision-making within the DAO LLC is conducted through smart contract-facilitated voting, ensuring transparency and equity. Proposal submission, review, and voting procedures are meticulously outlined, with defined quorum requirements and voting thresholds."
          />
          <StaticNeonBlock
            title="Profit Distribution and Financial Management"
            iconName="distribution"
            text="The protocol generates revenue for token holders who lock their tokens in a smart contract. Token holders are responsible for paying their Taxes as per their Jurisdiction."
          />
          <StaticNeonBlock
            title="Dispute Resolution Mechanisms"
            iconName="partners"
            text="The American Arbitration Association will oversee dispute resolution, offering a structured and efficient method for resolving internal conflicts or external disagreements. It will prioritize mediation or arbitration as a cost-effective solution."
          />

          <StaticNeonBlock
            title="Amendment Procedures"
            iconName="amendment"
            text="Amendments to this Operating Agreement are subject to a structured review process, including announcement, surveying of members, and a mandatory waiting period before conducting a referendum, ensuring all stakeholders have a voice in any changes."
          />
          <StaticNeonBlock
            title="Compliance and Legal Requirements"
            iconName="legal-requirements"
            text="This Agreement complies with applicable laws and regulations, ensuring the DAO LLC operates within legal bounds and adheres to industry standards. Regular consultations with legal experts safeguard against regulatory risks."
          />
          <StaticNeonBlock
            title="Transparency and Accountability"
            iconName="accountability"
            text="The DAO LLC is committed to openness, with regular audits, monthly reports, and disclosures made available to all members, supporting a culture of trust and long-term viability."
          />
          <StaticNeonBlock
            title="Termination Policy"
            iconName="termination-policy"
            text="Once deployed, the DEX223 protocol is designed to be unstoppable. Membership in the DAO LLC ceases when a member disposes of their governance tokens."
          />
          <StaticNeonBlock
            title="Tokenomics and Financial Transparency"
            iconName="financial-transparency"
            text="The D223 tokenomics model emphasizes fair distribution and revenue sharing among token holders and is committed to financial transparency. Quarterly financial reports detail how funds collected through fundraising are allocated and used."
          />
          <StaticNeonBlock
            title="Legal Jurisdiction"
            iconName="legal-jurisdiction"
            text="This Operating Agreement and any affiliated activities of the DEX223 DAO LLC are subject to the laws of Wyoming, USA."
          />
          <StaticNeonBlock
            title="Smart Contract Information"
            iconName="smart-contract"
            text={
              <Paragraphs
                paragraphs={[
                  ...
                  <UnorderedList
                    listItems={[
                      <span key="1">
                        <b className="text-primary-text">Private sale contract address:</b> <br />{" "}
                        0x9eb&shy;11e62b&shy;A74366&shy;C5AAA&shy;A7eEc8&shy;50FC31E&shy;7a3aCf1
                      </span>,
                      <span key="2">
                        <b className="text-primary-text">Public sale smart contract address:</b>{" "}
                        <br />{" "}
                        0x66&shy;bbbc069&shy;8fd3ac3&shy;c1f8bf6e&shy;2a550&shy;d3775&shy;a68879
                      </span>,
                      <span key="3">
